...
int main(int argc, char const *argv[])
{
	...
	while (checking != EOF)
	{
		...
		condensed_Na_on_O[currentTimeframe] = computeCondensedIons (inputCoordinates, nAtoms, "O", cutoff);
		condensed_Na_on_N[currentTimeframe] = computeCondensedIons (inputCoordinates, nAtoms, "N", cutoff);
